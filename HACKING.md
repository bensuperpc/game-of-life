...
hidden if the `game-of-life_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `game-of-life_DEVELOPER_MODE` to the configure
...
Runs the executable target `game-of-life_exe`.
